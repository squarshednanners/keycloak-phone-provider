        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    <input tabindex="1" type="text" id="firstName" class="${properties.kcInputClass!}" name="firstName"
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    <input tabindex="2" type="text" id="lastName" class="${properties.kcInputClass!}" name="lastName"
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    <input tabindex="3" type="text" id="email" class="${properties.kcInputClass!}" name="email"
            ...
            <#if !(realm.registrationEmailAsUsername || registrationPhoneNumberAsUsername??)>
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div class="${properties.kcInputWrapperClass!}">
                        <input tabindex="4" type="text" id="username" class="${properties.kcInputClass!}" name="username"
            ...
            <#if passwordRequired??>
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div class="${properties.kcInputWrapperClass!}">
                        <input tabindex="5" type="password" id="password" class="${properties.kcInputClass!}" name="password"
                ...
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div class="${properties.kcInputWrapperClass!}">
                        <input tabindex="6" type="password" id="password-confirm" class="${properties.kcInputClass!}"
            ...
            <#if phoneNumberRequired??>
                <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('phoneNumber',properties.kcFormGroupErrorClass!)}">
                    ...
                    <div class="${properties.kcInputWrapperClass!}">
                        <input tabindex="7" id="phoneNumber" class="${properties.kcInputClass!}"
                               ...
                               autocomplete="mobile tel" placeholder="555-555-5555" />
                ...
                <div class=" ${properties.kcFormGroupClass!} row">
                    ...
                    <div class="col-xs-8" style="padding: 0 5px 0 0">
                        <input tabindex="9" id="code" name="code"
                    ...
                    <div class="col-xs-4" style="padding: 0 0 0 5px">
                        <input tabindex="8" style="height: 36px"
            ...
            <div class="${properties.kcFormGroupClass!}">
                <div id="kc-form-options" class="${properties.kcFormOptionsClass!}">
                    <div class="${properties.kcFormOptionsWrapperClass!}">
                        <span><a tabindex="11" href="${url.loginUrl}">${kcSanitize(msg("backToLogin"))?no_esc}</a></span>
                    </div>
                </div>

                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    <input tabindex="10" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" type="submit" value="${msg("doRegister")}"/>
                </div>
            </div>
        </form>
        </div>
